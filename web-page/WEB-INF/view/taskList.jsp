...
<body>
	<div class="container" style="margin-top: 20px;">
		<div>
			...
			</select> <label style="margin-left: 10px"> Type </label> <select
				name="type_id" style="margin-left: 5px">
			...
			</select> <label style="margin-left: 10px"> Priority </label> <select
				name="task_priority" style="margin-left: 5px">
				<option>Highest</option>
				<option>High</option>
				<option>Medium</option>
				<option>Low</option>
			</select>
			<button id="btnSearchTask" name="actionSearchTask" value="actionSearchTask"
		...
		<table style="margin-top: 50px;" class="table table-bordered">
			<thead>
				<tr>
					...
					<th scope="col" style="background-color: #3AD<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html xmlns:th="http://www.thymeleaf.org">
