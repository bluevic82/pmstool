...
<body>
	...
	<div class="container" style="overflow: auto; height: 51.5%; position: relative;">
		<c:forEach var="list" items="${list}">
			<div id="divMain_Effort" style="width: 1000px; height: 50px">

				<div
					style="width: 200px; height: 50px; background-color: Gainsboro; float: left; text-align: center; padding: 10px 10px 10px "><b>
